...
double Compute(float a, float b, int n, void *Function, int method, int point){
	...
	switch (point) {
	case 2:
		xm[0] = -0.5773503;	xm[1] = -0.5773503;
		cm[0] = 1;	cm[1] = 1;
		break;
	case 3:
		xm[0] = -0.7745967;	xm[1] = 0; xm[2] = 0.7745967;
		cm[0] = 0.5555556;	cm[1] = 0.8888889;	cm[2] = 0.5555556;
		break;
	case 4:
		xm[0] = -0.8611363;	xm[1] = -0.3399810; xm[2] = 0.3399810; xm[3] = 0.8611363;
		cm[0] = 0.3478548;	cm[1] = 0.6521451;	cm[2] = 0.6521451; cm[3] = 0.3478548;
	}
